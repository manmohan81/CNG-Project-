...
fixed_data = [
    ...
    {"Task": "Finalization of Costing", "Start": datetime(2026, 10, 25), "End": datetime(2026, 10, 30)},
    {"Task": "Dispenser Certification", "Start": datetime(2026, 10, 15), "End": datetime(2026, 12, 8)},
]
